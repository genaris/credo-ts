...
export interface MediatorModuleConfigOptions {
   ...
   *
   *
   * - `MessageForwardingStrategy.QueueOnly` - simply queue encrypted message into QueueTransportMessageRepository. It will be in charge of manually trigering MessagePickupApi.deliver() afterwards.
   * - `MessageForwardingStrategy.QueueAndLiveModeDelivery` - Queue message into QueueTransportMessageRepository and deliver it (along any other queued message).
