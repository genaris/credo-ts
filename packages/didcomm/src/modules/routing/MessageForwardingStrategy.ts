export enum MessageForwardingStrategy {
  // When a forward is received, simply queue encrypted message. QueueTransportMessageRepository
  // will be in charge of manually triggering MessagePickupApi.deliverMessages()
  QueueOnly = 'QueueOnly',

  // Queue message into QueueTransportMessageRepository and, if a Message Pickup Live mode session is active,
